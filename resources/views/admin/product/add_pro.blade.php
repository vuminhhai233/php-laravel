                ...
                <div class="panel panel-default">
                    <div class="panel-body" style="background-color: #ecf0f1; color:#27ae60;">
                        ...
                        <form action="" method="POST" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                        Khuyến mãi: <input type="text" name="txtpromo" id="inputtxtpromo" value="{{ old('txtpromo') }}" class="form-control" >
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                                        Bộ nhớ : <input type="text" name="txtStorage" id="inputtxtStorage" value="{{ old('txtStorage') }}" class="form-control" >
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                                        PIN : <input type="text" name="txtBattery" id="txtBattery" value="{{ old('txtBattery') }}" class="form-control" >
                                    </div>
                                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                            ...
                            <div class="form-group">
                                <label for="input-id">Hình ảnh chi tiết sản phẩm</label>
                                <div class="row">
                                    @for( $i=1; $i<=8; $i++)
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <textarea name="txt_Intro" id="inputTxt_Intro" class="form-control" value="{{ old('txt_Intro') }}" rows="2" required="required"></textarea>
