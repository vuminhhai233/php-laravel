                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
                      <div class="panel panel-info" style="margin: 0;">
                        ...
                        <div class="panel-body">
                          <div class="khuyenmai">
                             <li><span class="glyphicon glyphicon-ok-sign"style="padding-right:5px"></span>Trả góp 0%</li>   
                              <li><span class="glyphicon glyphicon-ok-sign"style="padding-right:5px"></span>Bảo hành chính hãng 12 tháng</li> 
                              <li><span class="glyphicon glyphicon-ok-sign"style="padding-right:5px"></span>Tặng Windows 10</li> 
                              <li><span class="glyphicon glyphicon-ok-sign"style="padding-right:5px"></span>Giảm 50% giá khi mua thêm chuột, bao da</li>   
                              <li><span class="glyphicon glyphicon-ok-sign"style="padding-right:5px"></span>Ưu đãi 30% phí sửa chữa/thay thế linh kiện sau bảo hành</li> 
                      ...
                      <div class="panel panel-info">
                        <div class="panel-body">
                         <div class="chinhsach">
                            ...
                            <li><span class="glyphicon glyphicon-hand-right"style="padding-right:5px"></span> 1 đổi 1 trong 1 tháng với sản phẩm lỗi</li>
                         </div>
                        </div>
                      </div>
                      @if($data->status ==1)
